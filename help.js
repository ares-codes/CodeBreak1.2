...
const help = () => {
  ...
  if (children.length) {
    ...
    para.innerHTML =
      ...
      " A guess must be a eight-letter" +
      CODE +
    ...
    para.innerHTML =
      ...
      "(correct) or " +
      wrong +
      "(wrong). If you think 2 tiles are the same letter indictae this with a " +
      same +
      "(same) or leave blank if you dont know anything.";
    para.style.fontSize = "calc(10px + 1.5vh)";
    para.style.textAlign = "center";
    guess.appendChild(para);
    ...
    para.innerHTML =
      "Move the cursor(" +
      cursor +
      ") with the arrow keys to get to specific tiles.";
    para.style.fontSize = "calc(10px + 1.5vh)";
    para.style.textAlign = "center";
    guess.appendChild(para);
