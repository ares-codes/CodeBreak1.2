...
const strategy = () => {
  ...
  if (children.length) {
    ...
    para.innerHTML =
      " CODEBREAK can be a hard game for new players. This page is meant to give one possible strategy to first time players. One way to play this game is with the two-swap method. The idea with the two-swap method is that you start off by having one guess and then your next guess involves you swapping two of the letters while keeping everything else the same from the previous guess. Look below to see all the possible cases with this strategy.";
    ...
    strat.appendChild(document.createElement("hr"));
